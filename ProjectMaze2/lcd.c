...
void HAL_LCD_writeCommand(uint8_t command){
    ...
    // Transmit data, writing to UCxTXBUF activates the bit clock generator, and the data begins to transmit
